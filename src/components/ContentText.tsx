...
export function ContentText({ page }: { page: Page }) {
	return (
			<div className="prose prose-sm lg:prose-base w-full max-w-full md:max-w-prose mx-auto px-4 md:px-10">
			...
			if (!title) {
				return (
					<div className="my-6 flex justify-center">
						<svg viewBox="0 0 140 10" className="h-2.5 w-full max-w-35 overflow-visible" aria-hidden="true">
